...
#Load files
C57BL10_relabellednew <- readRDS("C:/Users/lgmheezen/OneDrive - LUMC/Ahmed_Laura_Pietro/Deconvolution/Spotlight/211108_C57BL10_relabellednew.rds")
...
spotlight_ls <- spotlight_deconvolution(
  se_sc = combined,
  counts_spatial = C57BL10_relabellednew@assays$Spatial@counts,
...
saveRDS(object = spotlight_ls, file = "C:/Users/lgmheezen/OneDrive - LUMC/Ahmed_Laura_Pietro/Deconvolution/Spotlight/Laura/spotlight_ls_WT.rds")
...
rownames(decon_mtrx) <- colnames(C57BL10_relabellednew)

decon_df <- decon_mtrx %>%
  data.frame() %>%
  tibble::rownames_to_column("barcodes")

C57BL10_relabellednew@meta.data <- C57BL10_relabellednew@meta.data %>%
  tibble::rownames_to_column("barcodes") %>%
  dplyr::left_join(decon_df, by = "barcodes") %>%
  tibble::column_to_rownames("barcodes")

Seurat::SpatialFeaturePlot(
  object = C57BL10_relabellednew,
...
SPOTlight::spatial_scatterpie(se_obj = C57BL10_relabellednew,
                              cell_types_all = cell_types_all,
                              img_path = "C:/Users/lgmheezen/OneDrive - LUMC/Ahmed_Laura_Pietro/Deconvolution/Spotlight/tissue_lowres_image_WT.png",
                              pie_scale = 0.4)
...
decon_df$clusterlabel <- C57BL10_relabellednew@meta.data[["relabelled"]]
write.csv(decon_df, "C:/Users/lgmheezen/OneDrive - LUMC/Ahmed_Laura_Pietro/Deconvolution/Spotlight/Laura/ProportionsClusters_C57BL10.csv") #save as csv
