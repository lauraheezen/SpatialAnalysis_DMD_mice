...
#Load files
D2mdx_relabellednew <- readRDS("C:/Users/lgmheezen/OneDrive - LUMC/Ahmed_Laura_Pietro/Deconvolution/Spotlight/211108_D2mdx_relabellednew.rds")
...
combined <- Seurat::SCTransform(combined, verbose = FALSE) %>%
  Seurat::RunPCA(., verbose = FALSE) %>%
  Seurat::RunUMAP(., dims = 1:30, verbose = FALSE)

Seurat::DimPlot(combined,
                group.by = "cluster",
...
combined@meta.data %>%
  ...
  gt::cols_label(
    cluster = gt::html("Cell Type")
  )


Seurat::Idents(object = combined) <- combined@meta.data$cluster
cluster_markers_all <- Seurat::FindAllMarkers(object = combined,
                                              slot = "data",
                                              verbose = TRUE, 
                                              only.pos = TRUE)

saveRDS(object = cluster_markers_all, file = "C:/Users/lgmheezen/OneDrive - LUMC/Ahmed_Laura_Pietro/Deconvolution/Spotlight/cluster_markers_all2.rds")


##Run
spotlight_ls <- SPOTlight::spotlight_deconvolution(
  se_sc = combined,
  counts_spatial = D2mdx_relabellednew@assays$Spatial@counts,
...
saveRDS(object = spotlight_ls, file = "C:/Users/lgmheezen/OneDrive - LUMC/Ahmed_Laura_Pietro/Deconvolution/spotlight_ls_D2_laura.rds")
saveRDS(object = combined, file = "C:/Users/lgmheezen/OneDrive - LUMC/Ahmed_Laura_Pietro/Deconvolution/combined2_laura.rds")
...
rownames(decon_mtrx) <- colnames(D2mdx_relabellednew)
...
##
D2mdx_relabellednew@meta.data <- D2mdx_relabellednew@meta.data %>%
  tibble::rownames_to_column("barcodes") %>%
  dplyr::left_join(decon_df, by = "barcodes") %>%
  tibble::column_to_rownames("barcodes")

p1 <- Seurat::SpatialFeaturePlot(
  object = D2mdx_relabellednew,
...
png(filename = "C:/Users/lgmheezen/OneDrive - LUMC/Ahmed_Laura_Pietro/Deconvolution/Spotlight/Laura/d2mdx_mph.png",
...
png(filename = "C:/Users/lgmheezen/OneDrive - LUMC/Ahmed_Laura_Pietro/Deconvolution/Spotlight/Laura/d2mdx_fap.png",
    width = 8, height = 6, units = "in", res = 300,
    bg = "transparent")
p1 <- Seurat::SpatialFeaturePlot(
  object = D2mdx_relabellednew,
...
##
SPOTlight::spatial_scatterpie(se_obj = D2mdx_relabellednew,
                              cell_types_all = cell_types_all,
                              img_path = "C:/Users/lgmheezen/OneDrive - LUMC/Ahmed_Laura_Pietro/Deconvolution/Spotlight/tissue_lowres_image_D2.png",
                              pie_scale = 0.4)
...
decon_df$clusterlabel <- D2mdx_relabellednew@meta.data[["relabelled"]]
write.csv(decon_df, "C:/Users/lgmheezen/OneDrive - LUMC/Ahmed_Laura_Pietro/Deconvolution/Spotlight/Laura/ProportionsClusters.csv") #save as csv
